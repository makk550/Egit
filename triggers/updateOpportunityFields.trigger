  ...
  set<String> fieldSet = new Set<String>();
    ...
    if(Trigger.isUpdate && Trigger.isBefore){
       ...
       for(Opportunity_Registration__c o: trigger.new){
         //if(o.Registration_Status__c == 'Modifying' && o.Second_Approver__c != null) o.Registration_Status__c = 'Second';
           if(o.Registration_Status__c == 'Rejected') {
               o.isApproved__c='False';
               o.Modifying__c = 'Yes';
           }
         if((o.Registration_Status__c != 'New' && o.Registration_Status__c !='Pending Approval' && trigger.oldMap.get(o.Id).Registration_Status__c == 'Partially Approved') || o.Registration_Status__c == 'Rejected'){
    ...
    {    
          ...
          for(Opportunity_Registration__c oppReg: Trigger.new){
             ...
             if(oppReg.Registration_Status__c == 'Rejected')
