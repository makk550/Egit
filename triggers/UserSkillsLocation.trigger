trigger UserSkillsLocation on User_Skills__c(before update, before insert) {
    //log.startTrigger('UserSkillsLocation');
        ...
        for(User_Skills__c US: listUS){
            ...
            for(User_Skills__c USB: listUSB){
                if(US.Id == USB.Id){
                    ...
                    if((US.Start_Time1__c != null || US.Start_Time10__c != null) && USB.Business_Hours__r.SundayEndTime == null){ US.Start_Time1__c.addError('Please confirm business Day in business hours');}
                   	if((US.Start_Time2__c != null || US.Start_Time20__c != null) && USB.Business_Hours__r.MondayEndTime == null){US.Start_Time2__c.addError('Please confirm business Day in business hours');}
                    if((US.Start_Time3__c != null || US.Start_Time30__c != null) && USB.Business_Hours__r.TuesdayEndTime == null){US.Start_Time3__c.addError('Please confirm business Day in business hours');}
                    if((US.Start_Time4__c != null || US.Start_Time40__c != null) && USB.Business_Hours__r.WednesdayEndTime == null){US.Start_Time4__c.addError('Please confirm business Day in business hours');}
                    if((US.Start_Time5__c != null || US.Start_Time50__c != null) && USB.Business_Hours__r.ThursdayEndTime == null){US.Start_Time5__c.addError('Please confirm business Day in business hours');}
                    if((US.Start_Time6__c != null || US.Start_Time60__c != null) && USB.Business_Hours__r.FridayEndTime == null){US.Start_Time6__c.addError('Please confirm business Day in business hours');}
                    if((US.Start_Time7__c != null || US.Start_Time70__c != null) && USB.Business_Hours__r.SaturdayEndTime == null){US.Start_Time7__c.addError('Please confirm business Day in business hours');}
