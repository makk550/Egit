...
if (Trigger.isAfter && Trigger.isUpdate)
{
    ...
    List<Active_Contract_Product__c> acpList = [select Id, ATTRF_CRV__c,Contracted_Renewal_Amount_LC__c,Current_Ann_Existing_Maintenance_LC__c,Active_Contract__c,Active_Contract__r.Id,
                                      (select Id, Orig_ATTRF_LC__c,Contracted_Renewal_Amount__c,Current_Annu_Existing_Maintenance__c,Contract_Product__c,Contract_Product__r.Active_Contract__r.Id from Active_Contract_Line_Items__r)
        from Active_Contract_Product__c where Active_Contract__r.Id in :changedACMap.keySet()];
