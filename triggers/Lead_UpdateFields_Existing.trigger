    ...
    try {
        for(Lead ld:Trigger.New) {  
            ...
            {       
                ...
                //we will update the reseller contact if CPMS id is changed
                if(ld.CPMS_Reseller_Contact_ID__c!=null && ld.CPMS_Reseller_Contact_ID__c!=oldLead.CPMS_Reseller_Contact_ID__c)
                {
